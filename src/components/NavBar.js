        ...
        <>
            <nav className="navbar navbar-expand-lg" id='navB'>
                <div className="container-fluid"> 
                    <Link className="navbar-brand" style={styleForAnchorTag} to="/TextAnalyzer-React">{props.title}</Link>
                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <Link className="nav-link active" style={styleForAnchorTag} aria-current="page" to="/TextAnalyzer-React">{props.navHead[0]}</Link>
                        </li>
                        <li className="nav-item">
                        <Link className="nav-link" style={styleForAnchorTag} to="/TextAnalyzer-React/about">{props.navHead[1]}</Link>
                        </li>
                        <li className="nav-item">
                        <Link className="nav-link" style={styleForAnchorTag} to='/TextAnalyzer-React/contact' aria-disabled="true">{props.navHead[2]}</Link>
                        </li>
                    </ul>
                    ...
                    <form className="d-flex" role="search">
                        ...
                        {/* <a href="https://wa.me/9821459302">Message Me Now</a> */}
                    </form>
                    </div>
                </div>
            </nav>
